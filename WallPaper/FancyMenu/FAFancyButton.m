...
- (CABasicAnimation *)fadeInAnimation{
    ...
    scaleAnimation.fromValue = [NSNumber numberWithFloat:0.01];//[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.01, 0.01, 0.1)];
    scaleAnimation.toValue = [NSNumber numberWithFloat:1];//[NSValue valueWithCATransform3D:CATransform3DMakeScale(1, 1, 1)];
...
- (CABasicAnimation *)fadeOutAnimation{
    ...
    CABasicAnimation *scaleAnimation = [CABasicAnimation animationWithKeyPath:@"transform.scale"];
    scaleAnimation.toValue = [NSNumber numberWithFloat:0.01];//[NSValue valueWithCATransform3D:CATransform3DMakeScale(0.01, 0.01, 0.1)];
    scaleAnimation.fromValue = [NSNumber numberWithFloat:1];//[NSValue valueWithCATransform3D:CATransform3DMakeScale(1, 1, 1)];
    scaleAnimation.duration = 0.15f;
    scaleAnimation.delegate = self;
    return scaleAnimation;
}
